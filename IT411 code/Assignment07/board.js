...
//     cell -- string indicating html element with id 
...
//    board.setBoard();
//    cell = document.querySelector('#cellb1');
//    board.dig(cell)  --> returns a ruin object if present, undefined otherwise
//
